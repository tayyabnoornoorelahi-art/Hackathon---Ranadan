...
window.fillDemo = function(role) {
    ...
    const demos = {
        'admin': { name: 'Admin Bhai', email: 'admin@demo.com', pass: 'admin123' },
        'doctor': { name: 'Dr. Sharma', email: 'doctor@demo.com', pass: 'doctor123' },
        'receptionist': { name: 'Priya Reception', email: 'reception@demo.com', pass: 'reception123' },
        'patient': { name: 'Rahul Patient', email: 'patient@demo.com', pass: 'patient123' }
    };
    
    document.getElementById('username').value = demos[role].name;
...
window.showRegisterPatient = function() {
    const content = document.getElementById('content');
...
window.showNewPrescription = function() {
...
window.getAIExplanation = function() {
